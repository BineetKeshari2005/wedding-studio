...
const Settings: React.FC = () => {
  const { user, profile, isAuthenticated, loading: authLoading, logout, updateDisplayName, changePassword } = useAuth();
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-2xl mx-auto px-6 pt-20 pb-12 lg:py-16 space-y-10">
          <div>
          ...
          <section className="glass rounded-xl p-6 space-y-5">
            ...
            <div className="flex items-center gap-2 text-sm font-body">
              ...
              <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                ...
                {profile?.plan === "pro" ? "Pro" : profile?.plan === "pro_plus" ? "Pro+" : "Free"}
              </span>
              <span className="text-muted-foreground ml-2">{profile?.credits ?? 0} credits</span>
            </div>
          ...
          <section className="glass rounded-xl p-6 space-y-4">
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 glass rounded-lg px-4 py-3 font-body font-medium text-foreground tracking-widest text-lg">
                {profile?.inviteCode || "LOVERS-XXXXXX"}
              </div>
